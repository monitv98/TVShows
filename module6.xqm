                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-lg-12 text-center">
                                        <h1>Escribe la serie que quieres eliminar de la base de datos</h1>
                                    </div>
                                </div>
                            </div>
      </header>
                        <div>
                            <div class="row">
                                ...
                                <div class="col-lg-10 text-center text-white bg-dark">
                                    ...
                                    <br/>
                                    <br/>
                                     <form class="form-inline justify-content-center" action="/delfor" method="POST">
